def arithmetic_arranger(problems,solve=False):
    ...
    def determine_spaces(arr_numbers,arr_dash,arr_sum):
        ...
        for i in range(len(arr_topnums)): #find the length of spaces in numbers
            ...
            if '-' not in arr_sum[i]:
                ...
                arr_sumlen.append(len(arr_dash[i]) - len(arr_sum[i])) #for negative numbers
        ...
        return arr_topspaces,arr_bottomspaces,arr_sumspaces,arr_topnums,arr_botnums #return array of spaces for line 1 and 2
    ...
    '''
    error = ''
    error = errors(problems)  # if this returns something it doesnt stop the program
    if error != '':
        ...
        arr_sum = determine_sum(arr_numbers, arr_operands)  # calculate arrsum
        arr_topspaces,arr_bottomspaces,arr_sumspaces,arr_topnums,arr_bottomnums = determine_spaces(arr_numbers,arr_dash,arr_sum) #determine spaces infront of numbers
        arranged_problems = display_output(arr_topspaces, arr_bottomspaces,arr_sumspaces,arr_topnums, arr_bottomnums,arr_sum) #display output
